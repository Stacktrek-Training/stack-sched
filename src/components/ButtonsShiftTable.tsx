...
const ButtonsShiftTable = () => {
    return (
        <div className='flex flex-wrap w-full justify-end'>
            {/* sub header buttons */}
            <div className="inline-flex flex-wrap rounded-md shadow-sm mt-[0.01rem] h-[2.45rem] align-top" role="group">
                ...
                <div className='flex max-w-screen'>
                    {/* previous button */}
                    <button type="button" className="inline-flex items-center px-2.5 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                ...
                {/* next button */}
                <button data-modal-target="add-modal" data-modal-toggle="add-modal" type="button" className="inline-flex items-center px-2.5 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-r-md hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
