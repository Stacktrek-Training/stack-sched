                ...
                <table className="bg-black-200 w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  <tbody className='overflow-y-auto'>
                    ...
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      ...
                      {/* name column */}
                      <td scope="row" className="flex items-center px-2 py-4 h-16 text-gray-900  dark:text-white text-[0.85rem]">
                    ...
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      ...
                      <td scope="row" className="flex items-center px-2 py-4 h-16 text-gray-900  dark:text-white text-[0.85rem]">
                        ...
                        <div className="pl-3 pt-2">
                          <div className="font-semibold">Miguel Edvenson Jay (Ed)</div>
                          <div className="font-normal text-gray-500">09xxxxxxxxx</div>
                    ...
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      ...
                      <td scope="row" className="flex items-center px-2 py-4 h-16 text-gray-900  dark:text-white text-[0.85rem]">
                        ...
                        <div className="pl-3 pt-2">
                          <div className="font-semibold">Sabino Rustia (Mutya)</div>
                          <div className="font-normal text-gray-500">09xxxxxxxxx</div>
                        ...
                        <div>
                          <div>
                            ...
                            <div className="grid gap-6 mb-6 md:grid-cols-2">
                              ...
                              {/* available time */}
                              <div>
                                <label className="mb-4 text-sm font-medium text-gray-900 dark:text-white">Available Time</label>
                            ...
                            {/* available days */}
                            <div>
                              <label className="mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Available Days</label>
                      ...
                      <div className="grid gap-12 md:grid-cols-2">
                        <div>
                          <div>
                            ...
                            {/* shift days */}
                            <div>
                              <label className="mb-2 text-sm font-medium text-gray-900 dark:text-white">Shift Days</label>
                              <ul className="mt-1 items-center w-full text-sm font-medium text-gray-900  rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                {/* monday */}
                                <li className="w-full  dark:border-gray-600">
                                  <div className="flex items-center pl-3">
