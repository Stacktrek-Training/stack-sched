    ...
    <div>
      <div>
        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
          ...
          <div class="m-auto mt-[-1rem]">
            {/* division for card (on-board) */}
            <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-52 h-36 m-5 ml-52">
              <table class="dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-full h-full">
                <thead>
                  <tr class="font-bold text-center text-m">ON-BOARD</tr>
                </thead>
                <tbody>
            ...
            <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-52 h-36 m-5 ml-[29rem] mt-[-10.3rem]">
              <table class="dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-full h-full">
                <thead>
                  <tr class="font-bold text-center text-m">WAITING</tr>
                </thead>
                <tbody>
                  <td className="text-[#2B7AD8] font-bold text-[3rem] text-center">
                    13
            ...
            <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-52 h-36 m-5 ml-[44.6rem] mt-[-10.3rem]">
              <table class="dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-full h-full">
                <thead>
                  <tr class="font-bold text-center text-m">CANCELLED</tr>
                </thead>
                <tbody>
                  <td className="text-[#2B7AD8] font-bold text-[3rem] text-center">
                    13
            ...
            {/* division for card (cancelled) */}
            <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-52 h-36 m-5 ml-[60rem] mt-[-10.3rem]">
              <table class="dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-full h-full">
                <thead>
                  <tr class="font-bold text-center text-m">TRAINERS</tr>
                </thead>
                <tbody>
                  <td className="text-[#2B7AD8] font-bold text-[3rem] text-center">
                    13
